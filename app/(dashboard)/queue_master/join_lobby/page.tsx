...
import AuthFormInput from "@/app/components/ui/AuthFormInput";
...
export default function JoinLobbiesPage() {
    ...
    return (
        <div className="flex flex-col lg:flex-row lg:justify-center items-center gap-16 lg:gap-32 mt-8 lg:mt-42">
            <JoinTile>
            ...
            <JoinTile>
                <div className="flex flex-col items-center cursor-pointer">
                    <p className="font-bold text-2xl flex items-center gap-2">Join via QR</p>
                    <MdQrCodeScanner className="text-9xl"/>
                </div>
            </JoinTile>
        </div>
