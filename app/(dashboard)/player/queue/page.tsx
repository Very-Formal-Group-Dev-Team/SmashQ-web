...
export default function QueuePage() {
    ...
    return (
        <div className="flex flex-col">
            {lobbyGames.length > 0 && (
                <div className="mb-8">
                    <h1 className="text-3xl sm:text-5xl font-display text-secondary">My Games</h1>
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mt-8">
                        {lobbyGames.map(lg => {
                            ...
                            return (
                                <div key={lg.lobby_id} className="bg-secondary rounded-xl border-3 border-accent hover:border-accent/80 transition duration-200 hover:shadow-lg hover:shadow-accent/20 shadow-md px-8 py-6 flex flex-col gap-3">
