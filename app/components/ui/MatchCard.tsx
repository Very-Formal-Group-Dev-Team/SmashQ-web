...
export default function MatchCard({ id, team1, team2 }: matchProps) {
    
    return (
        <button className="bg-secondary h-56 p-8 rounded-md border flex flex-col gap-10 cursor-pointer transform duration-150 hover:-translate-y-1.5 hover:shadow-xl">
