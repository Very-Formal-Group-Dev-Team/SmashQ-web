...
export default function AuthForm({ mode }: { mode: Mode }) {
    ...
    return (
        <div className="bg-primary min-h-lvh flex items-center justify-center px-4 py-6">
            <form className={`px-8 sm:px-10 pt-8 sm:pt-10 pb-8 sm:pb-10 bg-secondary flex flex-col justify-center items-center gap-6 rounded-xl w-full ${mode === "login" ? "max-w-[370px]" : "max-w-[370px] md:max-w-[750px] md:px-12"}`}>
